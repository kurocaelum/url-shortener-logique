package com.logique.urlshortener.security;
...
import com.logique.urlshortener.service.AuthProviderService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public UserDetailsService userDetailsServiceBean() throws Exception {
		return new AuthProviderService(userRepository);
	}
...
//		.withUser("david").password(passwordEncoder().encode("david2020")).authorities("USER")
//		.and()
